...
class Database():
    ...
    def getPostableInfo(self, currentuser, memberable, fqpn):
        ...
        postable=self._getPostable(currentuser, fqpn)
        ...
        #print "GOT HERE"
        owner = self._getUserForFqin(currentuser, postable.owner)
    ...
    def removePostable(self,currentuser, fqpn):
        ...
        rempostable=self._getPostable(currentuser, fqpn)
    ...
    def getGroup(self, currentuser, fqgn):
        return self._getPostable(currentuser, fqgn)

    def getApp(self, currentuser, fqan):
        return self._getPostable(currentuser, fqan)

    def getLibrary(self, currentuser, fqln):
        return self._getPostable(currentuser, fqln)
